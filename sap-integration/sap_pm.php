...
<head>
  ...
  <title>Oxmaint - SAP PM Module Integration</title>
<!-- Meta OG tags for Facebook -->
<meta property="og:title" content="SAP PM Module Integration with Oxmaint">
<meta property="og:description"
  content="Integrate SAP Plant Maintenance (PM) module with Oxmaint to streamline maintenance planning, execution, and asset management. Enhance reliability and reduce downtime with seamless data synchronization.">
<meta property="og:url" content="https://oxmaint.com/sap-pm-module-integration">
...
<meta name="twitter:title" content="Oxmaint: SAP PM Module Integration">
<meta name="twitter:description"
  content="Optimize plant maintenance operations by integrating SAP PM module with Oxmaint. Automate work orders, monitor assets, and improve maintenance efficiency with ease.">
...
<body>
      ...
      <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-5 mb-lg-6 align-items-center">
        <div class="col-lg-6 mt-lg-n10 text-center text-lg-start" data-cues="slideInDown" data-group="page-title" data-delay="600" data-disabled="true">
          <h1 class="display-2 mb-5 text-primary" data-cue="slideInDown" data-group="page-title" data-delay="600" data-show="true"
            ...
            SAP Plant Maintenance(PM) module Integration with Oxmaint</h1>
          <p class="lead fs-22 lh-sm mb-7 px-md-10 px-lg-0" data-cue="slideInDown" data-group="page-title" data-delay="600" data-show="true"
            ...
            Integrating SAP PM with Oxmaint enhances maintenance operations by connecting work order management and preventive maintenance scheduling. This
            real-time synchronization reduces equipment downtime, improves asset reliability, and optimizes maintenance processes.</p>
        ...
        <div class="col-lg-6 mx-auto position-relative" data-cue="zoomIn"
          ...
          data-show="true">
          <figure class="rounded"><img src="./images/sap_pm_hero.png" alt="automation">
          </figure>
        </div>
        <!--/column -->
      </div>
  ...
  <div class="container mt-10 py-2 py-md-2">
        ...
        <div class="row text-center">
          <div class="col-lg-11 col-xxl-9 mx-auto" data-cues="zoomIn" data-group="welcome" data-interval="-200" data-disabled="true">
            <h4 class="display-4 mb-4 text-primary" data-cue="zoomIn" data-interval="-200" data-group="welcome" data-show="true"
              ...
              Working of SAP PM Integration with Oxmaint</h4>
            <p class="lead fs-24 lh-sm px-md-5 px-xl-15 px-xxl-10 mb-7" data-cue="zoomIn" data-interval="-200" data-group="welcome" data-show="true"
              ...
              SAP PM integration with Oxmaint connects work order management and preventive maintenance scheduling for real-time data synchronization.
          </div>
        </div>
      </div>
    ...
    max-width: 100%;
    margin: 0 auto;">
        <img src="./images/sap_pm_working.png" alt="" style="max-width: 100%;
        height: auto;
        display: block">
    </div>     -->
      <div class="row text-center mt-10">
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2" data-cues="zoomIn" data-group="welcome" data-interval="-200" data-disabled="true">
          <figure data-cue="zoomIn" data-interval="-200" data-group="welcome" data-show="true"
            ...
            <img class="w-auto" src="./images/sap_pm_working.png" alt="">
          </figure>
        </div>
        <!-- /column -->
      </div>
